...
class Items_model extends CI_Model {
	...
	var $column_order = array( 'a.id','a.item_image','a.item_code','a.item_name','c.unit_name','a.stock','a.alert_qty','a.purchase_price','a.final_price','d.tax_name','d.tax','a.status','e.customer_name','a.tax_type','a.hsn','a.sku','a.height','a.width','a.length','a.ply','a.bf','a.gsm','a.color'); //set column field database for datatable orderable
	var $column_search = array( 'a.id','a.item_image','a.item_code','a.item_name','c.unit_name','a.stock','a.alert_qty','a.purchase_price','a.final_price','d.tax_name','d.tax','a.status','e.customer_name','a.custom_barcode','a.tax_type','a.hsn','a.sku','a.height','a.width','a.length','a.ply','a.bf','a.gsm','a.color'); //set column field database for datatable searchable 
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("CASE WHEN e.customer_name IS NULL THEN '' ELSE e.customer_name END AS customer_name");
		$this->db->join('db_customers as e','e.id=a.customer_id','left');
	...
	public function verify_and_save(){
		...
		$query1="insert into db_items(description,item_code,item_name,customer_id,height,width,length,ply,hsn,bf,gsm,color,sku,unit_id,alert_qty,lot_number,expire_date,
							...
							values('$description','$item_code','$item_name','$customer_id','$height','$width','$length','$ply','$hsn','$bf','$gsm','$color','$sku','$unit_id','$alert_qty','$lot_number','$expire_date',
									'$price','$tax_id','$purchase_price','$tax_type',$profit_margin,
									'$sales_price','$custom_barcode','$final_price',
