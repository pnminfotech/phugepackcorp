...
class Items_model extends CI_Model {
	...
	public function verify_and_save(){
		...
		$query1="insert into db_items(description,item_code,item_name,customer_id,height,width,length,ply,bf,gsm,color,sku,hsn,unit_id,alert_qty,lot_number,expire_date,
							...
							values('$description','$item_code','$item_name','$customer_id','$height','$width','$length','$ply','$bf','$gsm','$color','$sku','$hsn','$unit_id','$alert_qty','$lot_number','$expire_date',
									'$price','$tax_id','$purchase_price','$tax_type',$profit_margin,
									'$sales_price','$custom_barcode','$final_price',
