...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?= $this->lang->line('scrap_list'); ?>
        <small>View/Search scrap</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"><?= $this->lang->line('scrap_list'); ?></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header ">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>scrap/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('new_scrap'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><?= $this->lang->line('scrap_qty'); ?></th>
                  <th><?= $this->lang->line('scrap_for'); ?></th>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('scrap/ajax_list')?>",
            "type": "POST",
