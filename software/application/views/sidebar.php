...
<header class="main-header">
  ...
  <aside class="main-sidebar">
    ...
    <?php if($CI->permissions('purchase_add') || $CI->permissions('purchase_view') || $CI->permissions('purchase_return_view') || $CI->permissions('new_purchase_return')) { ?>
        ...
        <?php if($CI->permissions('scrap_add') || $CI->permissions('scrap_view') || $CI->permissions('scrap_category_add') || $CI->permissions('scrap_category_view')) { ?>
       <li class="scrap-list-active-li scrap-active-li scrap-category-active-li scrap-category-list-active-li treeview">
          <a href="#">
            <i class="fa fa-bitbucket   text-aqua"></i> <span><?= $this->lang->line('scrap'); ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if($CI->permissions('scrap_add')) { ?>
            <li class="scrap-active-li"><a href="<?php echo $base_url; ?>scrap/add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('new_scrap'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('scrap_view')) { ?>
            <li class="scrap-list-active-li"><a href="<?php echo $base_url; ?>scrap"><i class="fa fa-list "></i> <span><?= $this->lang->line('scrap_list'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('scrap_category_add')) { ?>
            <li class="scrap-category-active-li"><a href="<?php echo $base_url; ?>scrap/category_add"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('new_category'); ?></span></a></li>
            <?php } ?>
            <?php if($CI->permissions('scrap_category_view')) { ?>
            <li class="scrap-category-list-active-li "><a href="<?php echo $base_url; ?>scrap/category"><i class="fa fa-list "></i> <span><?= $this->lang->line('categories_list'); ?></span></a></li>
            <?php } ?>
    ...
    <?php if($CI->permissions('item_purchase_report') ||$CI->permissions('sales_report') || $CI->permissions('item_sales_report') || $CI->permissions('purchase_report') || $CI->permissions('purchase_return_report') || $CI->permissions('expense_report') || $CI->permissions('profit_report') || $CI->permissions('stock_report') || $CI->permissions('purchase_payments_report') || $CI->permissions('sales_payments_report') || $CI->permissions('expired_items_report')) { ?>
		<li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-profit-loss-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-purchase-item-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php if($CI->permissions('scrap_report')) { ?>
            <li class="report-scrap-active-li"><a href="<?php echo $base_url; ?>reports/scrap" ><i class="fa fa-files-o "></i> <span><?= $this->lang->line('scrap_report'); ?></span></a></li>
            <?php } ?>
