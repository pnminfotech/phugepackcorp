...
<table align="center" width="100%" height='100%' style="border:1px solid;">
  ...
  <tr style=''>
    ...
    <th style='border-right: 1px solid;border-top: 1px solid;' >Size</th>
    <th style='border-right: 1px solid;border-top: 1px solid;' >Ply</th>
...
<tbody style="border: 1px solid;">
 ...
 <?php
              ...
              $q2=$this->db->query("SELECT c.item_name, a.sales_qty,
                                  ...
                                  a.total_cost,c.hsn,c.ply,c.height,c.width,c.ply
                                  FROM 
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td style='border-right: 1px solid;border-top: 1px solid;'><lable>Height:</lable>".$res2->height."<br><lable>Width:</lable>".$res2->width."<br><lable>Length:</lable>".$res2->length."</td>";
                  echo "<td style='border-right: 1px solid;border-top: 1px solid;'>".$res2->ply."</td>";
