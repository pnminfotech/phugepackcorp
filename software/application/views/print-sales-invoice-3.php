...
<!-- <table align="center" width="100%" height='100%'   > -->
    ...
    <thead>
      ...
      <tr class="bg-sky"><!-- Colspan 10 -->
        ...
        <th colspan='3' class="text-center" ><?= $this->lang->line('description_of_goods'); ?></th>
        <th colspan='1' class="text-center">Size</th>
        <th colspan='2' class="text-center">Ply</th>
...
<tbody>
 ...
 <?php
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "</td>";
                  echo "<td colspan='1' class='text-left'><lable>Height:</lable>".$res2->height."<br><lable>Width:</lable>".$res2->width."<br><lable>Length:</lable>".$res2->length."</td>";
                  echo "<td colspan='2' class='text-left'>".$res2->ply."</td>";
