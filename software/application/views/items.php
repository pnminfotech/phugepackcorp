   ...
   <body class="hold-transition skin-blue  sidebar-mini">
    ...
    <!-- **********************MODALS END***************** -->
      ...
      <?php
         if(!isset($item_name)){
         $custom_barcode ='';
         $item_name=$sku=$hsn=$opening_stock=$item_code=$customer_id=$gst_percentage=$tax_type=
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <select class="form-control select2" id="customer_id" name="customer_id"  style="width: 100%;"  >
                                    <?php
                                       $query1="select * from db_customers where id>1";
                                 ...
                                 <span class="input-group-addon pointer" data-toggle="modal" data-target="#customer-modal" title="Add Customer"><i class="fa fa-plus-square-o text-primary fa-lg"></i></span>
                                    </div>
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <input type="text" class="form-control" id="height" name="height" placeholder="" value="<?php print $height; ?>" >
                              
                              </div>
                        
                              <div class="form-group col-md-4">
                                 <label for="Width">Width</label>
                                 <input type="text" class="form-control" id="width" name="width" placeholder="" value="<?php print $width; ?>" >
                              
                              </div>

                              <div class="form-group col-md-4">
                                 <label for="Length">Length</label>
                                 <input type="text" class="form-control" id="length" name="length" placeholder="" value="<?php print $length; ?>" >
                              
                              </div>

                              <div class="form-group col-md-4">
                                 <label for="Length">Hsn</label>
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <input type="text" class="form-control" id="ply" name="ply" placeholder="" value="<?php print $ply; ?>" >
                              
                              </div>

                              <div class="form-group col-md-4">
                                 <label for="BF">BF</label>
                                 <input type="text" class="form-control" id="bf" name="bf" placeholder="" value="<?php print $bf; ?>" >
                              
                              </div>

                              <div class="form-group col-md-4">
                                 <label for="GSM">GSM</label>
                                 <input type="text" class="form-control" id="gsm" name="gsm" placeholder="" value="<?php print $gsm; ?>" >
                              
                              </div>

                              <div class="form-group col-md-4">
                                 <label for="Color">Color</label>
                                 <input type="text" class="form-control" id="color" name="color" placeholder="" value="<?php print $color; ?>" >
