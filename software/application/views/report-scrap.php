      ...
      <div class="row">
        ...
        <label for="from_date" class="col-sm-2 control-label"><?= $this->lang->line('from_date'); ?></label>
          ...
          <option value="">-All-</option>
            <?php
            $q1=$this->db->query("select * from db_scrap_category where status=1");
             if($q1->num_rows()>0)
             {
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              ...
              <table class="table table-bordered table-hover  " id="report-data">
                <tr class="bg-blue">
                  <th style="">#</th>
                  <th style=""><?= $this->lang->line('scrap_code'); ?></th>
                  <th style=""><?= $this->lang->line('scrap_date'); ?></th>
                  <th style=""><?= $this->lang->line('category_name'); ?></th>
                  <th style=""><?= $this->lang->line('scrap_qty'); ?></th>
                  <th style=""><?= $this->lang->line('scrap_for'); ?></th>
...
<script src="<?php echo $theme_link; ?>js/report-scrap.js"></script>
