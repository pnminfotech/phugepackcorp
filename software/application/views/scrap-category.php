  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo $base_url; ?>scrap/category"><?= $this->lang->line('scrap_category_list'); ?></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info ">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" id="scrap-form" onkeypress="return event.keyCode != 13;">
...
<script src="<?php echo $theme_link; ?>js/scrap_category.js"></script>
