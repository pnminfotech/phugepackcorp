...
$('#save,#update').on("click",function (e) {
    ...
    if(this_id=="save")  //Save start
    {
					if(confirm("Do You Wants to Save Record ?")){
						...
						$.ajax({
						type: 'POST',
						url: base_url+'scrap/newcategory',
						data: data,
						cache: false,
						contentType: false,
						processData: false,
             ...
             // alert(result);return;
							if(result=="success")
							{
								window.location=base_url+"scrap/category";
								//return;
							}
	...
	else if(this_id=="update")  //Save start
    {
					...
					if(confirm("Do You Wants to Update Record ?")){
						...
						$.ajax({
						type: 'POST',
						url: base_url+'scrap/update_category',
						data: data,
						cache: false,
						contentType: false,
						processData: false,
...
function update_status(id,status)
{
	...
	$.post("scrap_update_status",{id:id,status:status},function(result){
		result=result.trim();
		if(result=="success")
				{
...
function multi_delete(){
    ...
    var this_id=this.id;
		...
		if(confirm("Are you sure ?")){
			...
			$.ajax({
			type: 'POST',
			url: base_url+'scrap/multi_delete',
			data: data,
			cache: false,
			contentType: false,
			processData: false,
